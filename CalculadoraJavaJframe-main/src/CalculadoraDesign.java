...
public class CalculadoraDesign extends javax.swing.JFrame {
   ...
   /* public void converte(){ //vai fazer a conversão de valores pra inteiro ou double, em caso de vírgula ou não
        if (!vir) {
            double n1 = Double.parseDouble(n1);
        } else {
            int n1 = Integer.parseInt(visor.getText());
        }
    } */
    
    public void calcula(){ //método para calcular os valores
        switch(op){
            case 1: 
                res = n1+n2;
                visor.setText(String.valueOf(res)); //faz logo a conversão em string aqui, ao invés de fazer separado como antes
                //n1 = res; //isso aqui é pra caso queira continuar somando com o valor já dado do resultado.
                break;
            case 2:
                res = n1*n2;
    ...
    private void SomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SomaActionPerformed
        //opera=true;
        n1 = Integer.parseInt(visor.getText()); //aqui ele pega o primeiro valor 
        op = 1;
        visor.setText("+"); //tirar o visor.getText... enfim
        
    }//GEN-LAST:event_SomaActionPerformed

    private void EqualsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EqualsActionPerformed
         n2 = Integer.parseInt(visor.getText()); //AQUI ele pega o segundo número!!!
        calcula(); //tá chamando o método com o switch-Case
